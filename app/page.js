    ...
    <>
      <header className="bg-white dark:bg-neutral-900 z-50 fixed top-0 left-0 h-[61px] w-full border-b shadow-sm flex items-center border-gray-200 dark:border-neutral-700 px-3 xl:pr-5">
        <div className="max-w-[1370px] relative h-14 w-full mx-auto flex items-center justify-between">
          <Link href="/" className="xs:ml-2 dark:hidden">
            <Image src="/logo.png" width={130} height={50} alt="logo" />
          </Link>
          <Link href={`/`} className="xs:ml-2 dark:block hidden">
            <Image src="/logo-dark.png" width={125} height={50} alt="logo" />
          </Link>
          <Searchbar />
          ...
          <ul className="flex gap-1 items-center">
            <li className="text-sm rounded border border-gray-200 dark:border-neutral-700 h-[36px] px-4 gap-1 hidden lg:flex items-center justify-center font-semibold text-[#23252F] dark:text-white dark:hover:bg-neutral-800 hover:bg-gray-100 cursor-pointer">
              <AiOutlinePlus
                size={19}
                className="text-[#23252F dark:text-white"
              />
              Upload
            </li>
