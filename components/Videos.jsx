...
import { FiHeart, FiMessageSquare, FiPlay, FiShare } from "react-icons/fi"
...
const Videos = () => {
  ...
  return (
    <div className="mt-[56px]    w-full px-4 lg:px-0  pb-8  grid   place-items-center lg:justify-items-center md:-ml-[88px] lg:-ml-[232px]">
      <div
        id="video-container"
...
const Tok = ({ username, name, caption, image, avatar }) => {
  return (
    <div className="relative flex  flex-col items-center justify-center cursor-pointer">
      ...
      <div className="hidden lg:block absolute left-full ml-3 top-0 order-2 rounded-xl w-[360px] mx-auto ">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="rounded-full h-14 w-14 mb-2">
              <Image
                src={avatar}
                alt="av"
                width={40}
            ...
            <div className="flex flex-col  -translate-y-1">
              ...
              <p className="text-neutral-600 text-sm -translate-y-0.5">{name}</p>
            </div>
          </div>
          <button className="border-2 border-red-400 rounded text-red-400 font-semibold py-1 px-6 text-sm self-start">
            Follow
          </button>
        </div>
      ...
      {/* video */}
      <div className="h-[545px] rounded-xl w-[305px] bg-gray-200 snap-start relative overflow-hidden">
        <Image
      ...
      <div className="hidden sm:flex flex-col gap-3 absolute bottom-1 left-full ml-3">
        ...
        <div className="flex flex-col justify-center items-center gap-2">
          <div className="grid place-items-center rounded-full w-[32px] h-[32px] bg-gray-200">
            <FiHeart size={20} className="text-red-500 order-2" />
          </div>
          <p className="text-xs font-bold">329.2k</p>
        </div>
        {/* comment icon */}
        <div className="flex flex-col justify-center items-center gap-2">
          <div className="grid place-items-center rounded-full w-[32px] h-[32px] bg-gray-200">
          ...
          <p className="text-xs font-bold">867</p>
        </div>
        {/* share icon  */}
        <div className="flex flex-col justify-center items-center gap-2">
          <div className="grid place-items-center rounded-full w-[32px] h-[32px] bg-gray-200">
          ...
          <p className="text-xs font-bold">2564</p>
        </div>
      </div>
    </div>
  )
